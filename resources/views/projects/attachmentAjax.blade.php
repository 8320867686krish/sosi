                    ...
                    <tbody>
                        @foreach ($attachment as $value)
                            <tr>
                                ...
                                <td>{{ $value['heading'] }}</td>
                                <td>
                                    <a href="{{ asset('images/attachment/' . $value['project_id'] . '/' . $value['documents']) }}"
                                        target="_blank">
                                        {{ $value['documents'] }}
                                    </a>
                                </td>
                                ...
                                @can('projects.edit')
                                    <td>
                                        <a href="#" rel="noopener noreferrer" data-attachment="{{ json_encode($value) }}"
                                            class="editAttachment" title="Edit">
                                            <i class="fas fa-edit text-primary" style="font-size: 1rem"></i>
                                        </a>
                                        <a href="#" class="ml-2" onclick="removeLab('{{ $value['id'] }}')"
                                            title="Delete">
