                    ...
                    <div class="card-body">
                        ...
                        <div class="campaign-info">
                            ...
                            <div class="progress mt-2 mb-3">
                                <div class="progress-bar" role="progressbar" aria-valuenow="{{$project->projectPercentage}}" aria-valuemin="0" aria-valuemax="100" style="width:{{$project->projectPercentage}}%">
