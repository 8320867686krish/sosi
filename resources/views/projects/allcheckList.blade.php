            ...
            @if (isset($project->checks) && $project->checks->count() > 0)
                @foreach ($project->checks as $check)
                   ...
                   <td class="text-center">
                           <a href="javascript:;" class="editCheckbtn" data-dotId="dot_{{ $loop->iteration }}" data-id="{{ $check->id }}"><i class="fas fa-edit text-primary" style="font-size: 1rem"></i></a>
                           <a href="javascript:;" class="modalCheckbtn ml-2" data-id="{{ $check->id }}"><i class="fas fa-images text-primary" style="font-size: 1rem"></i></a>
                   </td>
               </tr>
                    @endif
