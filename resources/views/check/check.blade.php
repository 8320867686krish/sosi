...
<head>
    ...
    <script type="text/javascript" src="{{ asset('assets/vendor/zoom/jquery.axZm.js') }}"></script>
    <link type="text/css" href="{{ asset('assets/vendor/zoom/axZm.css') }}" rel="stylesheet" />

    <!-- Javascript to style the syntax, not needed! -->
    <link name="az_editor_css_scripts" rel="stylesheet" href="{{ asset('assets/vendor/zoom/prism.css') }}" type="text/css"
        media="screen">
    <script type="text/javascript" src="{{ asset('assets/vendor/zoom/prism.min.js') }}"></script>
    ...
    <style type="text/css" media="screen">
        ...
        .axZmToolTipTitle {
            ...
            line-height: 18px;
            min-height: 24px;
            text-shadow: 0px 0px 2px rgba(150, 150, 150, 0.75);
        }
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">AJAX-ZOOM (for developers)<br />tagging images with hotspots, adding title and
                    description;<br />
            ...
            <div class="col-md-7">
                <div class="embed-responsive" style="padding-bottom: 80%; border: #000 1px solid">
                    ...
                    <div id="azParentContainer" class="embed-responsive-item"
                        style="max-height: 94vh; max-height: calc(100vh - 50px);">
                        Loading, please wait...
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <p style="margin-top: 0;">This snippet is not ment to represent a final or complete solution!
                    ...
                    Normally you would be saving the resulted JSON to a file, database, push to another persons display
                    or perform
                    some other fancy stuff with it. For example in a Digital-Asset-Management system the marketing
                    manager
                ...
                ?>
                <h3>HTML in body</h3>
                <p style="margin-top: 0;">azTaggingResults shows JSON created after placing the hotspots, so it is not
                ...
                <h3>Javascript</h3>
                <p style="margin-top: 0;">Every line is commented... The whole code could be ofcourse wraped into
                    external JS.
    ...
    <script type="text/javascript" id="exampleJs">
        ...
        ajaxZoom.parameter = "zoomData={{ asset('assets/images/welcame_mail_img.jpg') }}";
        ...
        ajaxZoom.evaluateClick = function(info) {
            ...
            $.fn.axZm.createNewHotspot({
                ...
                name: Math.random().toString(36).substring(2) + "_" + ((new Date()).getTime() - ajaxZoom
                    .timeDiff),
        ...
        ajaxZoom.toolTipHtml = function(info) {
            ...
            if (ajaxZoom.taggingMode) {
                ...
                ret = "<div>";
                // title
                ret += "<input type=\"text\" id=\"azTextField\" class=\"azTextField\" value=\"" + (info.labelTitle ||
                    ajaxZoom.taggingTxt.title) + "\">";

                // description
                ret += "<textarea id=\"azTextArea\" class=\"azTextArea\">" + (myTags.descr || ajaxZoom.taggingTxt
                    .description) + "</textarea>";
                ...
                ret += "<input type=\"button\" class=\"azButton\" value=\"Delete\" onclick=\"ajaxZoom.deleteHotspot('" +
                    info.name + "');\">";
            ...
            $.each(ajaxZoom.myTags, function(name, obj) {
                if ($.axZm.hotspots[name] &&
                    ...
                    json[name] = {
                        ...
                        position: $.fn.axZm.convertHotspotPositionToPx($.axZm.hotspots[name]["position"][$
                            .axZm.zoomID
                        ])
                    };
                }
        ...
        ajaxZoom.opt = {
            ...
            onBeforeStart: function() {
                ...
                $.axZm.icons.mCustomBtn1 = {
                    file: $.axZm.buttonSet + "/button_iPad_tag",
                    ext: "png",
                    w: 50,
                    h: 50
                };
