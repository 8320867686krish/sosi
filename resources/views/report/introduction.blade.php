    ...
    <section id="section1.4" class="next section-1-4">
        ...
        <table>
            ...
            <tbody>
                ...
                if ($hazmat->short_name == 'CY') {
                if ($hazmat->sample_count > 0 || $hazmat->visual_count > 0) {
                $show = true;
                }
                } else {
                // Handle the case where short_name is not 'CY'
                $show = false; // or whatever logic you want for this case
                }
                @endphp
                @if($show == true)
                <tr>
