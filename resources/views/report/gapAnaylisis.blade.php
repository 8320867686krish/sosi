<div class="container">
    ...
    <div class="section-1-1">
        ...
        <p>This analysis of the Initial IHM (Part-1)  report provided by the owner to bridge gaps with requirements laid out in HKC- MEPC.379(80) &  EUSRR IHM requirements as per EMSA guidelines, and/or other limitations and challenges associated while making the Inital IHM reports & Additional samplings for the vessel <b>{{$projectDetail['ship_name']}}</b> on behalf of <b>{{$projectDetail['client']['manager_name']}}</b>.</p>
    ...
    <div class="section-1-1">
        ...
        <p>Upon the request from the <b>{{$projectDetail['client']['manager_name']}}</b>, Solution for Overall Ship India Pvt. Ltd. (herein after referring as SOS India) visited the vessel for preparation of Gap analysis (herein after referring as GA) for the previous Inventory of Hazardous Material (IHM) provided by Vessel Owner.</p>
    ...
    <div class="section-1-1">
        <h3>1.5 Abbreviations & Normative References</h3>
        <h4>Abbreviation</h4>
        <ul>
